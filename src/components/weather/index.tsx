  ...
  return (
    <div className="container"> 
      ...
      sx={{
        ...
        <div className="temp">
          <img src={pathIconWeather(currentWeather.weather[0].icon)} alt="icon-weather" />
          <h1>{currentWeather.main.temp} °C</h1>
        </div>
        <div>
          <span><strong>Sensación térmica</strong> {currentWeather.main.feels_like}°C  {currentWeather.weather[0].description} </span>
          <small>(Temperatura Min: {currentWeather.main.temp_Min} - Temperatura Max: {currentWeather.main.temp_Max})</small>
        </div> 
        <p>
